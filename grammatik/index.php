...
?>
<!doctype html><html lang="de"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Grammatik – Französische Lernkarten</title><link rel="stylesheet" href="style.css">
<style>
...
<header class="hero"><div class="dharma-wheel" aria-hidden="true">🇮🇹</div><p class="eyebrow">Französische Lernkarten</p><h1>Grammatik</h1><p class="intro">Grammatik nach Stichworten durchsuchen und zugehörige PDF-Unterlagen öffnen.</p></header>
