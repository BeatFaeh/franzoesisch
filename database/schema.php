...
$db->query("CREATE TABLE IF NOT EXISTS franzoesisch_woerter_und_saetze (
...
$db->query("CREATE TABLE IF NOT EXISTS französisch_einstellungen (
...
$db->query("CREATE TABLE IF NOT EXISTS französisch_verben (
 id INT NOT NULL AUTO_INCREMENT,
 ...
 PRIMARY KEY(id),
 FULLTEXT KEY ft_französisch_verben (verb_it, verb_de, praesens, perfekt, futur, imperativ)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci");

$db->query("CREATE TABLE IF NOT EXISTS französisch_grammatik (
 id INT NOT NULL AUTO_INCREMENT,
...
$db->query("CREATE TABLE IF NOT EXISTS französisch_links (
 id INT NOT NULL AUTO_INCREMENT,
