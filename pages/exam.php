...
if (!in_array($countRaw, ['25', '50', '100', 'alle'], true)) {
    $countRaw = '25';
}

$requested = $countRaw === 'alle'
    ? null
    : (int)$countRaw;

$exam = $examService->build(
    $requested,
    $direction,
    $selectedTopics
);
...
<head>
    ...
    <title>Französisch-Prüfung</title>
...
<main class="exam-page">
    ...
    <div class="exam-wrapper">
        ...
        <section class="exam-config-card">
            ...
            <h2>Prüfung zusammenstellen</h2>

            <form
                    method="get"
                    class="exam-config-form"
            >
                ...
                <label>
                    ...
                    <select name="anzahl">
                        ...
                        <?php foreach (['25', '50', '100', 'alle'] as $n): ?>
                        ...
                        <?php foreach ($topics as $topic): ?>
                            ...
                            <label class="lesson-option">
                                ...
                                <input
                                        ...
                                        name="thema[]"
                                        value="<?= Html::e($topic) ?>"
                                    <?= in_array($topic, $selectedTopics, true) ? 'checked' : '' ?>
                                >
        ...
        <?php foreach ($questions as $i => $q): ?>
            ...
            <section
                    class="exam-question"
                    data-correct="<?= Html::e($q['correct_key']) ?>"
            >
