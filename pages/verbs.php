...
<head>
    ...
    <title>Französische Verben</title>
...
<main class="verbs-page">
    <header class="verbs-header">
        <div>
            ...
            <p>Französische und deutsche Verben mit allen erfassten Verbformen.</p>
        </div>
        <nav class="verbs-actions">
            <a class="button" href="index.php?action=verben-pdf&amp;sort=it<?= $search !== '' ? '&amp;suche=' . rawurlencode($search) : '' ?>">🖨 PDF Französisch A–Z</a>
    ...
    <section class="search-panel">
        <form method="get" action="index.php">
            ...
            <label>Volltextsuche – Französisch, Deutsch oder Verbform
