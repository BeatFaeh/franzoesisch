...
$sortLabel = $sort === 'de' ? 'Deutsch A–Z' : 'Französisch A–Z';
?>
<!doctype html>
<html lang="de">
<head>
    ...
    <title>Französische Verben – PDF</title>
        ...
        <form method="get" action="index.php" class="sort-form">
            ...
            <label>PDF sortieren nach
                <select name="sort" onchange="this.form.submit()">
                    <option value="it" <?=$sort==='it'?'selected':''?>>Französisch A–Z</option>
...
<main class="document">
    <h1>Französische Verben</h1>
    <p class="subtitle">Übersicht aller Verbformen · Sortierung: <?=Html::e($sortLabel)?><?= $search !== '' ? ' · Suche: ' . Html::e($search) : '' ?></p>
    <table>
        <thead><tr><th>ID</th><th>Französisch</th><th>Deutsch</th><th>Endung</th><th>Präsens</th><th>Perfekt</th><th>Futur</th><th>Imperativ</th></tr></thead>
        <tbody>
